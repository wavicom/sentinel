...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to wavid "gobject list" output
    ...
    def wavid_serialise(self):
        import wavilib
        return wavilib.SHIM_serialise_for_wavid(self.serialise())
